...
<body>
    ...
    def run_analysis(self, output_formats: list[str]) -> bool:
        ...
        print("Heapdump Analyzer by lenin (Ghost)")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""Examples:
  python heapdump_analyzer.py -f heap.dump -o json         # Only generate JSON report
  python heapdump_analyzer.py -f heap.dump -o html         # Only generate HTML report
  python heapdump_analyzer.py -f heap.dump --all           # Generate JSON, HTML, and TXT reports
"""
    )
    parser.add_argument(
        "-f", "--file",
